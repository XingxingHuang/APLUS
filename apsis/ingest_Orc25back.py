...
class DataSet:
    ...
    def buildObs(self):
        ...
        if not os.path.isdir(self.newobspath):
            ...
            # by XX 
    	    self.fobj = pyfits.open(os.path.join(self.ingestdir,self.fitslist[1]))
	      ...
	      if self.filter in ['F105W','F110W','F125W','F140W','F160W']:
            ...
            self.fobj.close()
            del self.fobj
            print  '_________________by Xingxing'
