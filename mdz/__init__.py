...
class Pattern:
    ...
    def buildProduct(self,filename,output,ref): #WZ
        ...
        # print "build product for ", filename # Apr 2013
        #pdb.set_trace()
    ...
    def buildPars(self,ref=None,def_wcs=None,tweak=0):
        ...
        # print "single Buildpars" # Apr 2013
        #pdb.set_trace() #WZ
        offsets = {}
...
class DitherProduct(Pattern):
    ...
    def __init__(self, prodlist,pars=None,ref=None): #WZ
        ...
        # print "Add product members" Apr 2013
    ...
    def addMembers(self,prodlist,pars,output):
        ...
        """
        # print "prod image. Update ref" Apr 2013
        # pdb.set_trace()
        #pd = self.ref.prod
        #md = self.ref.model
