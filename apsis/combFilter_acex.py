...
# $Id: combFilter.py,v 2.01 2010/12/08 20:15:45 zheng Exp $
# ---------------------------------------------------------------------

__version__      = '$Revision: 2.01 $ '[11:-3]
__version_date__ = '$Date: 2010/12/18 $ '[7:-3]
...
class detectionImage:
    ...
    def mkInvarIm(self):
        ...
        for im in self.statsList:
            ...
            naxis1   = ffi[0].header['NAXIS1']
            naxis2   = ffi[0].header['NAXIS2']
            ename = string.split(imName,'_drz')[0]+'_RMS.fits' #WZ
        ...
        #self.detFF[0].data = self.detFF[0].data/weight #WZ
